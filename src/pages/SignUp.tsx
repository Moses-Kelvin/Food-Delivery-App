...
const SignUp = () => {
    ...
    return (
        <section className="mt-12 bg-deepRed text-white w-[40%] m-auto h-fit py-8 rounded-lg shadow-xl sm:w-[90%]">
            <h1 className="text-2xl font-thin tracking-wider pl-8 pb-8">SignUp</h1>
            <form className="w-full grid justify-items-center card">
                <div className="group">
                    <input type="text" name="from_name" required autoComplete="off"/>
                    <span className="highlight"></span>
                    <span className="bar"></span>
                    <label className="font-thin font-lighter font-sm">username</label>
                </div>
                ...
                <button type="submit" className="bg-white m-auto text-lg text-deepRed rounded-md w-3/5 sm:w-4/5 py-2">SIGN UP</button>
            </form>
